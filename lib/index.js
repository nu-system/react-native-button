...
const _apiPrivate = {
    ...
    getButtonInfoByProps({styleConfig, useProps}) {
        ...
        for (let [propKey, propValue] of Object.entries(styleProps)) {
            for (let [domKey, domConfig] of Object.entries(domsConfig)) {
        ...
        for (let [key, customFunc] of Object.entries(customStyles)) {
    ...
    renderChildren({buttonInfo, Txt, before, after, children}) {
...
const NuButton = function ({theme = 'default', style, before, after, ...userProps}) {
